const ICONS = {
  courses: (
    <path strokeLinecap="round" strokeLinejoin="round" d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20M4 19.5V6.5A2.5 2.5 0 0 1 6.5 4H20v16H6.5A2.5 2.5 0 0 1 4 19.5Zm0 0V6.5" />
  ),
  search: (
  ...
  assignments: (
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 12h6m-6 4h6M6.75 4.5h10.5A1.5 1.5 0 0 1 18.75 6v13.5a1.5 1.5 0 0 1-1.5 1.5H6.75A1.5 1.5 0 0 1 5.25 19.5V6A1.5 1.5 0 0 1 6.75 4.5Z" />
  ),
  profile: (
...
export default function DashboardIcon({ name, className = 'h-6 w-6' }) {
